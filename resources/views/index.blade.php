...
<body>
	...
	<section class="hero-section set-bg" data-setbg="img/bg.jpg">
		<div class="container hero-text text-white">
			...
			<p>Search Flate rooms & hostals on rentalland.com®.<br>Find property info from the most comprehensive source data.</p>
	...
	<div class="filter-search" style="background-color: blue">
		<div class="container" style="background-color: black">
			...
			@csrf
				...
				<select name="state">
				<option value="">-</option>
					<option value="Punjab">Madhyapradesh</option>
					<option value="Sindh">Madhyapradesh</option>
					<option value="Kpk">Madhyapradesh</option>
					<option value="Blochistan">Madhyapradesh</option>
				</select>
	...
	<section class="feature-category-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h3>LOOKING Flates&room</h3>
				<p>What kind of flates are you looking for? We will help you</p>
			</div>
			<div class="row">
